...
-- CreateEnum
CREATE TYPE "EthinecityEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');
...
CREATE TABLE "Model" (
    ...
    "ethinicity" "EthinecityEnum" NOT NULL,
